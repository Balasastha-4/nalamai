      ...
      body: _isLoading 
        ...
        : SingleChildScrollView(
            ...
            _buildRiskCard(
              context: context,
              title: 'Diabetes Risk',
              riskLevel: _getDiabetesRisk((demoData['glucose'] as num?)?.toDouble() ?? 0.0),
            ...
            _buildRiskCard(
              context: context,
              title: 'Obesity Risk',
              riskLevel: _getObesityRisk((demoData['bmi'] as num?)?.toDouble() ?? 0.0),
        ...
        children: [
          ...
          ..._warnings.map((w) => Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("• ", style: TextStyle(color: AppTheme.error, fontWeight: FontWeight.bold)),
                Expanded(child: Text(w, style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color))),
              ],
            ),
          )),
        ],
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildInputItem(context, 'Heart Rate', '${data['heartRate']} bpm'),
